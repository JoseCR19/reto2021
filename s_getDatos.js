...
const handlerWrapperArgs = { functionName: 'reto2021-dev-getDatos', timeout: 6 };

try {
  const userHandler = require('./src/handler.js');
  module.exports.handler = serverlessSDK.handler(userHandler.obtenerDatos, handlerWrapperArgs);
} catch (error) {
